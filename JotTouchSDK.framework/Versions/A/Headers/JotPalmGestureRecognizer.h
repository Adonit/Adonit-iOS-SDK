...
@class JotPalmRejector;
#define kRadiusOfPalm 100
...
@property (nonatomic, readonly) NSInteger _numberOfActiveTouches;
@property (nonatomic, readonly) BOOL didDetectPalm;

@property (nonatomic) JotPalmRejector *rejector;
...
-(void) setSuggestToDisable:(BOOL)suggest;
/**
...
-(void) addPalmTouches:(NSSet *)touches;
@end
