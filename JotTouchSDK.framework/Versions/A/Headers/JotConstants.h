...
/** 
 * Identifies the hardware model of a Jot
 */
typedef NS_ENUM(NSUInteger, JotModel) {
    /** The hardware model is unknown */
    JotModelUndefined = 0,
    /** Used for the Jot Touch 4 */
    JotModelJT4 = 2,
    /** Used for the original Jot Script */
    JotModelJS = 3,
    /** Used for the Jot Touch with Pixelpoint */
    JotModelJTPP = 4,
    /** Used for the Adobe Ink */
    JotModelMighty = 5,
    /** Used for the Jot Script with Pixelpoint */
    JotModelJSPP = 6,
    /** Used for the second generation Jot Touch with Pixelpoint */
    JotModelJTPP2 = 7
};
